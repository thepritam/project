...
public class UpcomingOrders extends Fragment {
    ...
    public static UpcomingOrders newInstance(String param1, String param2) {
        UpcomingOrders fragment = new UpcomingOrders();
...
//
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<UpcomingOrderFirebase, UpcomingOrdersViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull final UpcomingOrdersViewHolder holder, int position, @NonNull final UpcomingOrderFirebase model) {
                ...
                if(model.getCompleted() == 0 && model.getRiderOrder().isEmpty()==false) {
                                        ...
                                        docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                                            ...
                                            public void onEvent(@Nullable DocumentSnapshot snapshot,
                                                ...
                                                if (snapshot != null && snapshot.exists()) {
                                                    ...
                                                    final String assignedstate = snapshot.getData().get("Assigned").toString();
                                                    ...
                                                    docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                                                        ...
                                                        public void onEvent(@Nullable DocumentSnapshot snapshot,
                                                            ...
                                                            if (snapshot != null && snapshot.exists()) {
                                                                ...
                                                                if(snapshot.getData().get("PaidFull").toString().equals("1") && assignedstate.equals("1"))
                                                                {
                                                                    Log.d("fire", "Entered: " + snapshot.getData());

                                                                    fetchrider(assignedid, progressDialog,model.getOrderId(),snapshot.getData().get("InvoiceID").toString());
                                                                    ...
                                                                    Intent intent = new Intent(getActivity(), ShowOrders.class);
    ...
    public void fetchrider(final String aid, final ProgressDialog progressDialog,final String orderid,final String invoiceid) {
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(aid)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        placeorder(id, name, phone, riderlat, riderlon, rating,progressDialog,orderid,invoiceid);
...
//                        }
    ...
    private void placeorder(final String id, final String name, final String phone, final double riderlat, final double riderlon, final int rating,ProgressDialog progressDialog,final String orderid,final String invoiceid) {
