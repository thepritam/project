 ...
 */
public class TeacherCancelledOrders extends Fragment {
    ...
    private com.project.placesproject.tutor.TeacherCancelledOrders.OnFragmentInteractionListener mListener;
    ...
    public static TeacherCancelledOrders newInstance(String param1, String param2) {
        TeacherCancelledOrders fragment = new TeacherCancelledOrders();
...
//
                                                                 ...
                                                                 docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                                                                     ...
                                                                     public void onEvent(@Nullable DocumentSnapshot snapshot,
                                                                         ...
                                                                         if (snapshot != null && snapshot.exists()) {
                                                                             ...
                                                                             Intent intent = new Intent(getActivity(), ShowTutorCancelled.class);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof TeacherCancelledOrders.OnFragmentInteractionListener) {
            mListener = (TeacherCancelledOrders.OnFragmentInteractionListener) context;
        } else {
