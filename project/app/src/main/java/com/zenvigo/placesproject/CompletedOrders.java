...
import com.project.placesproject.grocery.ShowCompletedOrder;
...
public class CompletedOrders extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View root = inflater.inflate(R.layout.fragment_completed_orders, container, false);
                                                                                 ...
                                                                                 docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                                                                                     ...
                                                                                     public void onEvent(@Nullable DocumentSnapshot snapshot,
                                                                                         ...
                                                                                         if (snapshot != null && snapshot.exists()) {
                                                                                             ...
                                                                                             Intent intent = new Intent(getActivity(), ShowCompletedOrder.class);
