 ...
 */
public class TeacherUpcomingOrders extends Fragment {
    ...
    private com.project.placesproject.tutor.TeacherUpcomingOrders.OnFragmentInteractionListener mListener;
    ...
    public static TeacherUpcomingOrders newInstance(String param1, String param2) {
        TeacherUpcomingOrders fragment = new TeacherUpcomingOrders();
...
//
                                                                 ...
                                                                 docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                                                                     ...
                                                                     public void onEvent(@Nullable DocumentSnapshot snapshot,
                                                                         ...
                                                                         if (snapshot != null && snapshot.exists()) {
                                                                             ...
                                                                             Intent intent = new Intent(getActivity(), ShowTutorUpcoming.class);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof TeacherUpcomingOrders.OnFragmentInteractionListener) {
            mListener = (TeacherUpcomingOrders.OnFragmentInteractionListener) context;
        } else {
